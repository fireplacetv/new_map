...
function initLegend() {
  ...
  const colors = map.getPaintProperty("output-extrusion", "fill-extrusion-color").stops;

  colors.forEach(function(color, i) {
    const entry = document.importNode(template.content, true); // get HTML content of the template
